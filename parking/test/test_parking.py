...
class ParkingTest(TestCase):
    ...
    def test_index_data(self):
        ...
        resp = self.client.post(
            '/', {'RUT': '195563039', 'nombre': 'ana', 'apellido': 'perez', 'sexo': 'M', 'edad': 19,
    ...
    def test_index_invalid_rut(self):
        ...
        self.assertEqual(response.status_code, 200)
        resp = self.client.post(
            '/', {'RUT': '195563037', 'nombre': 'ana', 'apellido': 'perez', 'sexo': 'M', 'edad': 19,
                  'patente': 'ASDS21', 'marca': 'chevrolet', 'color': 'Rojo', 'chasis': 'as',
                  'numero': 111, 'dias': 7})
        self.assertEqual(resp.status_code, 200)
    ...
    def test_forms(self):
        form_data = {'RUT': '195563039', 'nombre': 'ana',
                     'apellido': 'perez', 'sexo': 'M', 'edad': 19}
